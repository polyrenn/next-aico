...
const DeleteBranch:FC<ModalProps> = (props) => {
    ...
    const deleteBranch = async (values: { branch: string}, actions:any) => {

      const branch = values.branch

      const res = await fetch(`/api/Common/DeleteBranch?id=${branch}`, {
        method: 'post',
      }).then( (res) => {
